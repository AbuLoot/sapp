...
@section('content')
  ...
  <p class="text-right">
    <a href="/{{ $lang }}/admin/doc_types" class="btn btn-primary"><i class="material-icons md-18">arrow_back</i></a>
  </p>
  <div class="row">
    <div class="col-md-7">
      <div class="panel panel-default">
        <div class="panel-body">
          <form action="{{ route('doc_types.store', $lang) }}" method="post">
            {!! csrf_field() !!}
            <div class="form-group">
              <label for="type">Тип</label>
              <input type="text" class="form-control" id="type" name="type" value="{{ (old('type')) ? old('type') : NULL }}">
            </div>
            <div class="form-group">
