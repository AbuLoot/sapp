...
class PaymentTypeController extends Controller
{
    public function index()
    {
        ...
        return view('joystick.payment_types.index', compact('payment_types'));
    }
    ...
    public function create($lang)
    {
        ...
        return view('joystick.payment_types.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect($request->lang.'/admin/payment_types')->with('status', 'Запись добавлена.');
    }
    ...
    public function edit($lang, $id)
    {
        ...
        return view('joystick.payment_types.edit', compact('payment_type'));
    }
    ...
    public function update(Request $request, $lang, $id)
    {
        ...
        return redirect($lang.'/admin/payment_types')->with('status', 'Запись обновлена.');
    }
    ...
    public function destroy($lang, $id)
    {
        ...
        return redirect($lang.'/admin/payment_types')->with('status', 'Запись удалена.');
    }
}
