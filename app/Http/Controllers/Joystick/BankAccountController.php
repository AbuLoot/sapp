...
class BankAccountController extends Controller
{
    public function index()
    {
        ...
        return view('joystick.bank_accounts.index', compact('bank_accounts'));
    }
    ...
    public function create($lang)
    {
        ...
        return view('joystick.bank_accounts.create', ['currencies' => $currencies]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect($request->lang.'/admin/bank_accounts')->with('status', 'Запись добавлена.');
    }
    ...
    public function edit($lang, $id)
    {
        ...
        return view('joystick.bank_accounts.edit', compact('currencies', 'bank_account'));
    }
    ...
    public function update(Request $request, $lang, $id)
    {
        ...
        return redirect($lang.'/admin/bank_accounts')->with('status', 'Запись обновлена.');
    }
    ...
    public function destroy($lang, $id)
    {
        ...
        return redirect($lang.'/admin/bank_accounts')->with('status', 'Запись удалена.');
    }
}